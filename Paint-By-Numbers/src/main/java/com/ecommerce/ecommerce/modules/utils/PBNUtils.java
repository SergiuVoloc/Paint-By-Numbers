...
////        System.load(
////                "D:\\Programs\\OpenCV Java\\openCVVVV\\opencv\\build\\java\\x64\\opencv_java452.dll" );
////        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
//
//        int k = 10;
////        Mat img = Imgcodecs.imread(filename);
//        Mat img = Imgcodecs.imread("C:\\Users\\SergiuVoloc\\Desktop\\input.jpg");
//
//        List<Mat> clusters = cluster(img, k);
//        Imgcodecs.imwrite("clustered.png", clusters.get(0));
...
//     */
//    public static Mat drawEdges(List<Mat> clusters){
//
